...
public class TicketguruApplication {
	...
	public class LoadDatabase {
		...
		CommandLineRunner initDatabase(TapahtumaRepository tapahtumaRepository,
				TapahtumapaikkaRepository tapahtumapaikkaRepository, JarjestajaRepository jarjestajaRepository,
				YhteyshenkiloRepository yhteyshenkiloRepository, PostitoimipaikkaRepository postitoimipaikkaRepository,
				AsiakasryhmaRepository asryhRepository, KayttajaRepository kayttajaRepository,
				RooliRepository rooliRepository, LipputyyppiRepository lipputyyppiRepository,
			...
			return args -> {
				...
				Yhteyshenkilo yhteys1 = yhteyshenkiloRepository.save(new Yhteyshenkilo("Matti", "Meikäläinen",
						"matti@example.com", "0401234567", "Markkinointipäällikkö"));
				Yhteyshenkilo yhteys2 = yhteyshenkiloRepository.save(new Yhteyshenkilo("Liisa", "Laaksonen",
						"liisa@example.com", "0501234567", "Tuotantopäällikkö"));
				Yhteyshenkilo yhteys3 = yhteyshenkiloRepository.save(new Yhteyshenkilo("Jukka", "Järvinen",
				...
				Tapahtumapaikka paikka1 = tapahtumapaikkaRepository.save(new Tapahtumapaikka("Kulttuuritalo",
						"Sturenkatu 4, Helsinki", "Kulttuuritapahtumien keskus", "1234567-8", "info@kulttuuritalo.fi",
						"Esteetön pääsy", new ArrayList<>(), new ArrayList<>(), helsinki));
				Tapahtumapaikka paikka2 = tapahtumapaikkaRepository.save(new Tapahtumapaikka("Messukeskus",
						"Messuaukio 1, Helsinki", "Suomen suurin messukeskus", "2345678-9", "contact@messukeskus.fi",
						"Pysäköintitilaa saatavilla", new ArrayList<>(), new ArrayList<>(), helsinki2));
				Tapahtumapaikka paikka3 = tapahtumapaikkaRepository.save(new Tapahtumapaikka("Linnanmäki",
						"Tivolikuja 1, Helsinki", "Huvipuisto kaikenikäisille", "3456789-0", "info@linnanmaki.fi",
						"Koirat sallittu hihnassa", new ArrayList<>(), new ArrayList<>(), helsinki));

				// Luodaan järjestäjiä
				Jarjestaja jarjestaja1 = jarjestajaRepository
						.save(new Jarjestaja("Musiikki Oy", "1234567-8", "Mannerheimintie 13", helsinki, yhteys1));
				Jarjestaja jarjestaja2 = jarjestajaRepository
						.save(new Jarjestaja("Festivaali Oy", "2234567-8", "Bulevardi 14", helsinki, yhteys2));
				Jarjestaja jarjestaja3 = jarjestajaRepository
						.save(new Jarjestaja("Konsertti Oy", "3234567-8", "Fredrikinkatu 15", helsinki2, yhteys3));
				...
				Tapahtuma tapahtuma = tapahtumaRepository.save(new Tapahtuma("Rock Festivaali",
						ZonedDateTime.of(LocalDateTime.of(2024, 3, 22, 19, 0), ZoneId.of("Europe/Helsinki")),
						ZonedDateTime.of(LocalDateTime.of(2024, 3, 23, 01, 0), ZoneId.of("Europe/Helsinki")),
						"Suurin rock tapahtuma vuonna 2024", 50.00, paikka1, jarjestaja1, lipputyypit, 15000));
				tapahtumaRepository.save(new Tapahtuma("Jazz-ilta",
						ZonedDateTime.of(LocalDateTime.of(2024, 4, 20, 21, 30), ZoneId.of("Europe/Helsinki")),
						ZonedDateTime.of(LocalDateTime.of(2024, 4, 21, 02, 0), ZoneId.of("Europe/Helsinki")),
						"Nauti rennosta jazz-musiikista", 40.00, paikka2, jarjestaja2, lipputyypit, 70));
				tapahtumaRepository.save(new Tapahtuma("Stand-up show",
						ZonedDateTime.of(LocalDateTime.of(2024, 5, 15, 18, 0), ZoneId.of("Europe/Helsinki")),
						ZonedDateTime.of(LocalDateTime.of(2024, 5, 15, 22, 0), ZoneId.of("Europe/Helsinki")),
