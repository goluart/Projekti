...
public class TicketguruApplication {
	...
	public class LoadDatabase {
		...
		// Yhteyshenkilo yhteys1 = yhteyshenkiloRepository.save(new
		// Yhteyshenkilo("Matti",
		// "Meikäläinen",
		// "matti@example.com", "0401234567", "Markkinointipäällikkö"));
		// Yhteyshenkilo yhteys2 = yhteyshenkiloRepository.save(new
		// Yhteyshenkilo("Liisa",
		// "Laaksonen",
		// "liisa@example.com", "0501234567", "Tuotantopäällikkö"));
		// Yhteyshenkilo yhteys3 = yhteyshenkiloRepository.save(new
		// Yhteyshenkilo("Jukka",
		// "Järvinen",
		...
		// kayttajaRepository.save(new Kayttaja("myyja", "myyja", "Mäkinen", "Matti",
		// "Myyntialue", myyja));
		// kayttajaRepository.save(new Kayttaja("lipuntarkastaja", "lipuntarkastaja",
		// "Virtanen", "Veera",
		// "Tarkastusaluella", lipuntarkastaja));
		// kayttajaRepository
		// .save(new Kayttaja("hallinto", "hallinto", "Laaksonen", "Liisa",
		...
		// Lipputyyppi lapsi5 = lipputyyppiRepository.save(new Lipputyyppi("Lapsi", 0.5,
		// lapsi));
		...
		// // Luodaan tapahtumia
		// Tapahtuma tapahtuma = tapahtumaRepository.save(new Tapahtuma("Rock
		// Festivaali",
