                ...
                CommandLineRunner initDatabase(TapahtumaRepository tapahtumaRepository,
                        ...
                        return args -> {
                                ...
                                Lipputyyppi normaali = lipputyyppiRepository
                                                .save(new Lipputyyppi("Aikuinen", 1.0, aikuinen));
                                Lipputyyppi lapsi5 = lipputyyppiRepository.save(new Lipputyyppi("Lapsi", 0.5, lapsi));
                                ...
                                Tapahtuma tapahtuma = tapahtumaRepository.save(new Tapahtuma("Rock Festivaali",
                                                ZonedDateTime.of(LocalDateTime.of(2024, 3, 22,
                                                                19, 0), ZoneId.of("Europe/Helsinki")),
                                                ZonedDateTime.of(LocalDateTime.of(2024, 3, 23, 01, 0),
                                                                ZoneId.of("Europe/Helsinki")),
                                                "Suurin rock tapahtuma vuonna 2024", 50.00,
                                                paikka1, jarjestaja1, lipputyypit, 15000));

                                tapahtumaRepository.save(new Tapahtuma("Jazz-ilta",
                                                ZonedDateTime.of(LocalDateTime.of(2024, 4, 20, 21, 30),
                                                                ZoneId.of("Europe/Helsinki")),
                                                ZonedDateTime.of(LocalDateTime.of(2024, 4, 21,
                                                                02, 0), ZoneId.of("Europe/Helsinki")),
                                                "Nauti rennosta jazz-musiikista",
                                                40.00, paikka2, jarjestaja2, lipputyypit, 70));

                                tapahtumaRepository.save(new Tapahtuma("Stand-up show",
                                                ZonedDateTime.of(LocalDateTime.of(2024, 5, 15, 18, 0),
                                                                ZoneId.of("Europe/Helsinki")),
                                                ZonedDateTime.of(LocalDateTime.of(2024, 5, 15,
                                                                22, 0), ZoneId.of("Europe/Helsinki")),
                                                "Naurua koko illaksi", 35.00, paikka3,
                                                jarjestaja3, lipputyypit, 150));
                                ...
                                kayttajaRepository.save(
                                                new Kayttaja("salasana123", "Mäkinen", "Matti", "Myyntialue", myyja));
                                kayttajaRepository
                                                .save(new Kayttaja("salasana456", "Virtanen", "Veera",
                                                                "Tarkastusaluella", lipuntarkastaja));
                                kayttajaRepository.save(new Kayttaja("salasana789", "Laaksonen", "Liisa", "Hallinnossa",
                                                hallinto));
